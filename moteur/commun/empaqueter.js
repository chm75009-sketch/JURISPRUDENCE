...
const CHAMPS = (() => {
  ...
  for (const nom of ["questionnaire.js", "questionnaire-cse.js", "questionnaire-pse.js", "questionnaire-bdese.js", "questionnaire-nao.js", "questionnaire-sst.js"]) {
...
let APPELEES = {};
const PROPOSITIONS = (() => {
  for (const nom of ["propositions.js", "propositions-cse.js", "propositions-pse.js", "propositions-bdese.js", "propositions-nao.js", "propositions-sst.js"]) {
    const chemin = path.join(ICI, nom);
    if (!fs.existsSync(chemin)) continue;
    try {
