/* Relire à la source les articles que le module cite.
   ...
   autre partie du code — ou d'un AUTRE code lorsque le filtre de code ne porte
   pas. La capture de ce module a mesuré une autre difficulté : R. 1321-3,
   R. 1321-5, L. 1322-1 et R. 1332-3 ne prononcent pas les mots qu'on attendait
   d'eux — ils renvoient à l'article dont ils fixent le délai. UNE SEULE LECTURE NE PROUVE
   ...
   Usage : node verifier-textes-discipline.js [AAAA-MM-JJ]                          */
const fs = require("fs");
...
/* Le nom du code, pas son identifiant : le filtre NOM_CODE du relais attend le
   nom — voir capturer-textes-discipline.js et CLAUDE.md. */
...
fs.writeFileSync(__dirname + "/verification-textes-discipline.json",
