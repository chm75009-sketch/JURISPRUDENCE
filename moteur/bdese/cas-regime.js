...
const CAS = [
  ...
  { nom: "Dossier vide", f: {}, regime: REGIMES.INDETERMINE, cause: "accord non déclaré" },
  { nom: "Question sur l'accord laissée sans réponse", f: { effectif: 420 },
    regime: REGIMES.INDETERMINE, cause: "accord non déclaré" },
  { nom: "Accord d'entreprise déclaré mais non joint",
    f: { accordEntreprise: true, effectif: 420 },
    regime: REGIMES.INDETERMINE, cause: "accord déclaré non versé" },
  { nom: "Accord de branche déclaré mais non joint",
    f: { accordBranche: true, effectif: 120 },
    regime: REGIMES.INDETERMINE, cause: "accord de branche non versé" },
  { nom: "Aucun accord, effectif inconnu",
    f: { accordEntreprise: false, accordBranche: false },
    regime: REGIMES.INDETERMINE, cause: "effectif inconnu" },

  /* --- les accords --- */
  { nom: "Accord d'entreprise joint",
    f: { accordEntreprise: true, accordEntrepriseVerse: true, effectif: 420 },
    regime: REGIMES.ACCORD_ENTREPRISE },
  { nom: "Accord d'entreprise joint, petite entreprise",
    f: { accordEntreprise: true, accordEntrepriseVerse: true, effectif: 60 },
    regime: REGIMES.ACCORD_ENTREPRISE },
  { nom: "Accord de branche joint, moins de trois cents",
    f: { accordBranche: true, accordBrancheVerse: true, effectif: 120 },
    regime: REGIMES.ACCORD_BRANCHE },

  /* --- le cas qui trompe : l'accord de branche au-delà de trois cents --- */
  { nom: "Accord de branche joint, mais trois cents salariés et plus",
    f: { accordBranche: true, accordBrancheVerse: true, effectif: 340 },
    regime: REGIMES.SUPPLETIF, article: "R. 2312-9" },

  /* --- pas d'accord : c'est la loi, de part et d'autre du seuil de contenu --- */
  { nom: "Pas d'accord, moins de trois cents",
    f: { accordEntreprise: false, accordBranche: false, effectif: 299 },
    regime: REGIMES.SUPPLETIF, article: "R. 2312-8" },
  { nom: "Pas d'accord, exactement trois cents",
    f: { accordEntreprise: false, accordBranche: false, effectif: 300 },
    regime: REGIMES.SUPPLETIF, article: "R. 2312-9" },
  { nom: "Pas d'accord d'entreprise, la branche n'étant pas renseignée",
    f: { accordEntreprise: false, effectif: 120 },
    regime: REGIMES.SUPPLETIF, article: "R. 2312-8" },
];
