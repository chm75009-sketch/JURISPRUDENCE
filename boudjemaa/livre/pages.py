...
{"ch": "INTRODUCTION", "titre": "Un mythe à Béja",
 "t": [
  ...
  "Des centaines d'articles de la presse française ont été dépouillés pour ce travail, entre 1930 et 1950. Ce nom de famille y apparaît une fois. Une seule, sous une forme déformée, dans un bulletin de la Fédération de juillet 1936.",
  "Partout ailleurs, pendant douze ans, il n'est que Boudjemaa. Parfois Boudjema. Parfois Boudjéma. Très souvent rien d'autre que « le Nord-Africain ».",
  ...
  "La photographie qui suit est la plus ancienne image connue de son club. Elle a été prise à l'occasion du match du 8 février 1931, en Coupe de l'Afrique du Nord, à Bône : Bône 2, U.S. Béja 0. Sa légende ne nomme personne. Impossible, donc, de dire lequel de ces onze hommes est Martinelli I, lequel est Martinelli II, et si Boudjemaa y figure. Une photographie légendée est recherchée.",
 ],
...
{"ch": "INTRODUCTION", "titre": "Ce que l'auteur apportera",
 "t": [
  "Trois parties de cette introduction ne peuvent pas s'écrire ailleurs que dans la mémoire de l'auteur. Elles restent ouvertes à ce stade du manuscrit.",
  "La première, c'est sa vie à Béja et les matchs qu'il allait voir enfant, avec les noms des joueurs de ces années-là. Aucune archive ne les donne. Cela ne peut venir que de lui.",
  "La deuxième, c'est Mounir Ben Sakhria : l'ami, le président, celui à qui ce livre est dédié. Le dossier de recherche ne contient rien sur lui. Ni date, ni fonction précise, ni récit.",
  "La troisième, c'est le tournoi Boudjemaa, avec entre autres le Club Sportif Sfaxien et Hamadi Agrebi. À ce jour, le dossier n'a ni règlement, ni palmarès, ni date de fondation, ni la moindre coupure de presse.",
  "En regard, le derby de Béja tel que le racontait la presse de Tunis dans les années trente. C'est le football que voyaient les enfants de la ville. C'est celui d'où il est sorti.",
 ],
...
{"ch": "1. LA NAISSANCE", "titre": "Le jour, le lieu",
 "t": [
  "Mohamed Boudjemaa est né le 13 août 1914 à Béja, et plus précisément à Henchir El Hania. C'est la formule retenue pour ce livre. Voici ce qui la fonde.",
  "La date et le lieu viennent de son acte de décès, dressé à Colmar le 30 mai 1947 (registre des décès de l'année 1947, acte numéro 464). C'est le seul document d'état civil dont on dispose sur lui. Un seul, pour trente-deux ans de vie.",
  ...
  "La notice de l'Association Sportive de Saint-Étienne écrit le même lieu autrement : « né le 13 août 1914 à Henchir El Hania ». Les deux graphies désignent la même chose. Un nom arabe transcrit d'oreille, deux fois, par deux administrations françaises différentes. L'orthographe change, le lieu ne change pas.",
  "Relevons ce que l'acte ne dit pas. Ni le nom du père. Ni celui de la mère. Ni leur profession, ni leur domicile : « non connus du déclarant ». Un joueur professionnel meurt dans une ville française, et l'administration ignore jusqu'au nom de ses parents.",
 ],
 "fac": None,
...
{"ch": "1. LA NAISSANCE", "titre": "Béja ou Henchir El Hania",
 "t": [
  ...
  "Un henchir est un domaine agricole, une ferme et ses terres. Ce n'est pas un village. Personne, hors d'un registre, ne dit qu'il est né dans un henchir : on donne la ville dont il dépend, et ici c'est Béja. Ce n'est même pas un hameau comme El Menchar, qui, lui, a un nom sur les cartes.",
  "Les journaux qui écrivent Béja ne se trompent donc pas. Ils abrègent, comme abrège tout le monde.",
  "Le lieu précis reste celui que porte l'acte de décès. Et il faut continuer à le chercher là où il est : dans la campagne autour de Béja.",
  "L'article reproduit ensuite est signé Claude Thuillard. Il porte ce titre : « Tu le r'verras Paname ! » aurait dit dimanche le Red Star à BOUDJEMAA. C'est le seul portrait qu'un grand quotidien français ait publié de lui de son vivant, avec sa photographie. On y lit la phrase qui dit le mieux ce qu'il représentait chez lui : « Quelle joie alors à Béja et en Tunisie aussi ! »",
 ],
...
{"ch": "1. LA NAISSANCE", "titre": "Le récit d'une recherche qui n'a pas abouti",
 "t": [
  ...
  "Les Archives de l'Institut Pasteur de Tunis publiaient chaque année la liste des localités d'origine des personnes mordues et traitées. Trois années portent El Henaïa dans le contrôle de Béja : 1923, un cas ; 1925, deux cas ; 1926, trois cas.",
  "Ce sont, à ce jour, les seules attestations d'El Henaïa comme lieu où des gens vivaient, dans les années mêmes où il y est né et y a grandi.",
  "Le « Vocabulaire arabe-français des principaux termes de géographie » de 1882 donne : « Henia, el henaya : coude de rivière ». C'est une description de terrain, pas un nom propre unique. Voilà pourquoi on le retrouve un peu partout.",
 ],
 "fac": None,
...
{"ch": "1. LA NAISSANCE", "titre": "L'Union Sportive Béjaoise, et Martinelli",
 "t": [
  "Son club formateur est l'Union Sportive Béjaoise. La fiche de l'OGC Nice le dit sans ambiguïté.",
  "La notice de Saint-Étienne donne ensuite l'ordre complet de ses clubs, et c'est la seule source qui le donne : U.S. Béjaoise, E.S. Tunis, Club Africain, Sfax, Club Tunisien, O.G.C. Nice, A.S. Saint-Étienne, U.S. Béjaoise, Colmar, Nice, Espérance Tunis, Colmar.",
...
{"ch": "1. LA NAISSANCE", "titre": "Souk-Ahras, 30 juillet 1932",
 "t": [
  ...
  "Le compte rendu du match Rapid C.M. Souk-Ahras contre U.S. Béja, publié par le Souk-Ahras républicain du 30 juillet 1932, le donne dans la ligne d'avants béjaoise, à côté de Martinelli I.",
  "Avant cette date, rien. Rien dans la presse de Tunis. Rien dans celle d'Algérie. Rien dans les hebdomadaires sportifs.",
  "Ce jour de juillet 1932 est le premier jour de sa vie publique. Et il n'a pas lieu chez lui, mais de l'autre côté de la frontière, dans une ville de l'est algérien.",
  "Le fac-similé est donné en deux pages, parce que l'article court sur deux colonnes de longueur inégale. La seconde suit.",
 ],
...
{"ch": "1. LA NAISSANCE", "titre": "Souk-Ahras, la suite du compte rendu",
 "t": [
  ...
  "La notice de Saint-Étienne place dans cet intervalle l'Espérance Sportive de Tunis, le Club Africain, Sfax et le Club Tunisien. Sans aucune date.",
  "C'est le premier des grands trous de cette biographie. Il se comblera, s'il se comble, dans les archives tunisiennes.",
  "Une seule chose est sûre pour cette période : il a joué en Tunisie, et il y a été assez remarqué pour qu'un gardien de but niçois, Raoul Chaisaz, le ramène avec lui à la fin de 1935 et l'emploie dans son entreprise.",
 ],
...
{"ch": "1. LA NAISSANCE", "titre": "Deux clubs, et non pas un",
 "t": [
  ...
  "La preuve tient en une page : celle des résultats du football tunisien du 24 octobre 1949. Elle porte les deux noms le même jour et dans la même compétition, l'U.S. Béja en Coupe de Tunisie contre l'U.S.T., et l'Olympique contre l'A.S.F., dans un compte rendu qui parle des « Tricolores béjaois ».",
...
{"ch": "2. SOLLICITÉ EN FRANCE, VICTIME DE SON TALENT", "titre": "Les deux contrats",
 "t": [
  ...
  "La pièce qui fixe tout est la liste des demandes de licences de joueurs professionnels parvenues à la Fédération française de football association, publiée le 15 juillet 1936. Elle porte les deux, Nice et Saint-Étienne, dans la même colonne, sous deux noms qui ne sont pas tout à fait le même :",
  "> O.G.C. Nice. - Boudjemaa Mohamed (Français).   A.S. Saint-Etienne. - Boudjemaa Ben Mohamed el Memiti (Français).",
  "Il faut se représenter ce que cela veut dire. Ce jour-là, la Fédération a imprimé deux fois le même homme, à deux lignes de distance, sous deux identités légèrement différentes. Personne ne l'a remarqué.",
  "Tout ce qui va suivre tient dans ces deux lignes : la plainte, les commissions, la suspension, l'argent à rendre.",
 ],
...
{"ch": "2. SOLLICITÉ EN FRANCE, VICTIME DE SON TALENT", "titre": "« El Memiti »",
 "t": [
  ...
  "Cette ligne mérite qu'on s'y arrête. C'est la seule fois, dans tout ce dépouillement, que la presse française imprime autre chose que « Boudjemaa ».",
  "« El Memiti » : à la loupe, c'est bien un M majuscule, le même que celui de Mohamed sur la même ligne. Mais le stade de Béja s'appelle stade Boujemaa Kmiti, un K de plomb mal venu se lit très facilement en M, et « Memiti » n'a d'existence nulle part ailleurs.",
  "C'est donc probablement Kmiti. Je ne l'affirme pas : il faudrait l'acte de naissance ou un document tunisien pour le dire.",
  "En tout état de cause, c'est la seule apparition de son nom de famille dans douze ans de presse française.",
 ],
...
{"ch": "2. SOLLICITÉ EN FRANCE, VICTIME DE SON TALENT", "titre": "La suspension, en deux temps",
 "t": [
  "Trois mois, le 31 juillet 1936. La Commission centrale des statuts et règlements juge l'affaire à Paris, sur le dossier, sans entendre de délégué niçois.",
  "L'Éclaireur du Soir du 1er août : « Boudjemaa a été suspendu pour trois mois ferme, à dater du 30 août. Il ne pourra, de ce fait, rejouer que le 1er décembre 1936 et à l'O.G.C.N. bien entendu. »",
  "L'appel de Saint-Étienne est rejeté le 12 septembre 1936. L'Éclaireur de Nice du 13 septembre, sous le titre « Boudjemaa demeure qualifié à l'O.G.C. Nice » :",
...
{"ch": "2. SOLLICITÉ EN FRANCE, VICTIME DE SON TALENT", "titre": "Jugé sans être là",
 "t": [
  ...
  "Le président de la Fédération, Jules Rimet, tranche en une phrase :",
...
{"ch": "2. SOLLICITÉ EN FRANCE, VICTIME DE SON TALENT", "titre": "Ce qu'il en coûte, et la lettre en arabe",
 "t": [
  ...
  "Une réserve de date. Mario Brun, dans L'Intransigeant du 30 octobre 1936, place la confrontation des deux clubs au 18 août. Le procès-verbal officiel publié par Football la date du 13 août. Les deux ne peuvent pas être justes, et je n'ai pas tranché.",
  "Une note sur l'écrit, enfin. Plusieurs pièces répètent qu'il était illettré. La même affaire montre pourtant qu'il écrivait : sa lettre à la Fédération était rédigée en arabe, et c'est même l'un des points du dossier, « l'arabe n'étant pas déchiffrable pour tout le monde », écrit L'Intransigeant.",
  "Un homme qui écrit sa défense dans sa langue n'est pas un illettré. C'est un homme dont on ne lit pas la langue. La copie de cette lettre n'a pas été retrouvée.",
 ],
...
{"ch": "3. LE RACISME ET L'ESPRIT COLONIALISTE", "titre": "Le bled, les dattes, le mirage",
 "t": [
  ...
  "L'Intransigeant du 30 octobre 1936, Mario Brun : « on alla le tirer de son bled » ; « l'arabe n'étant pas déchiffrable pour tout le monde » ; « le petit footballeur tunisien » ; « Mettez-vous à la place du type qui, en plein bled, se voit offrir une petite fortune ». Et la fin de l'article : « Quant à Mohamed, dans son bled, il en a pour six mois à empaqueter des dattes... Il avait cru au mirage... »",
...
{"ch": "3. LE RACISME ET L'ESPRIT COLONIALISTE", "titre": "L'enfant, l'animal, l'illettré",
 "t": [
  ...
  "Le nom remplacé par l'origine, enfin. Le Sport alsacien du 14 novembre 1938 l'appelle « l'Arabe », au milieu d'un compte rendu où tous les autres joueurs sont nommés. Paris-soir du 30 mars 1937 : « Les nationaux comme Boudjema et Brusseaux ne feraient pas mal en division nationale. Encore des Nord-Africains, souligne Couard, réduit au rôle de spectateur. »",
 ],
 "fac": None,
...
{"ch": "3. LE RACISME ET L'ESPRIT COLONIALISTE", "titre": "Le système qui l'a fait venir",
 "t": [
  ...
  "L'étude décrit surtout le système. Le prospecteur : « Le dénommé Charles Elkabbach est présenté dans la presse sportive nationale comme l'homme qui a africanisé l'OM et le football français. Négociant en laines à Oran, cet homme a su dénicher et exporter en France de nombreux joueurs africains. »",
  ...
  "Il faut rappeler le cadre juridique. Le Code de l'indigénat n'est officiellement abrogé que par l'ordonnance du 7 mars 1944. Boudjemaa a joué, signé, été suspendu et jugé sous ce régime.",
  "Et il faut rappeler le retournement de 1946 : la Fédération interdit pendant deux ans tout nouveau transfert de footballeurs venus d'Afrique du Nord. Il rentre à Colmar en septembre 1945. En janvier 1946, on lui refuse sa licence amateur.",
 ],
...
{"ch": "4. LE MATCH AMICAL À MARSEILLE", "titre": "1er décembre 1935, Marseille 2 Nice 0",
 "t": [
  ...
  "Il n'est même pas encore qualifié. Il ne le sera qu'une semaine plus tard, le 8 décembre, contre Le Havre, pour son premier match officiel. Ce jour-là, L'Auto écrira son nom « Boudjena », ce qui est la meilleure preuve qu'on ne le connaissait toujours pas.",
 ],
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "L'arrivée à Nice, novembre 1935",
 "t": [
  ...
  "Son premier match sous le maillot niçois est un amical contre Roma, le 27 octobre 1935, perdu 1 à 0. Il joue toute la partie. La date vient de l'OGC Nice lui-même, par M. Michel Oreggia, dans un courriel du 10 janvier 2021. On lit parfois la date du 21 octobre : elle est fausse.",
  "L'Éclaireur du 28 octobre : « Un bel essai de Boudjemaa est bien sauvé par le goal Zucca. »",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "1936-1937, la meilleure saison",
 "t": [
  ...
  "7 mars 1937, Nice 3 Nancy 1. L'Auto-vélo du 8 mars, page 7 : « Boudjemaa place un shot du droit qui rentre au coin des filets, et c'est le troisième but. »",
  "Dans le même numéro, page 8, sous le titre « Boudjemaa a été demandé par un club écossais » : « le président d'un club écossais a assisté aujourd'hui au match OGC Nice contre FC Nancy et, impressionné par le jeu de Boudjemaa, a offert, séance tenante, 5 000 livres pour le transfert de ce joueur ».",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "1937-1938, Saint-Étienne et la maladie",
 "t": [
  ...
  "Il joue le 5 septembre à Alès et marque à la 16e minute. Le 19 septembre, il joue contre Bordeaux avec une furonculose, au point que son coéquipier le gardien Favier en admirera le courage. Il entre ensuite en clinique à Saint-Étienne.",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "Colmar, 2 juillet 1938",
 "t": [
  ...
  "Deux choses à relever. La date d'abord : son arrivée à Colmar est annoncée dès le 2 juillet 1938, soit cinq semaines avant le 10 août qui fera annuler le match contre Lens.",
  "L'âge ensuite. « Dans sa vingt-troisième année » veut dire vingt-deux ans révolus, alors qu'avec une naissance le 13 août 1914 il en avait vingt-trois ce jour-là. Le journal se trompe d'un an au moins.",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "L'équipe des Sports Réunis",
 "t": [
  ...
  "Une chose à noter. L'entraîneur de Colmar est Lowy, qui était déjà le sien à l'O.G.C. Nice en 1936. Deux ans après, dans une autre ville, c'est le même homme qui le fait jouer.",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "La réclamation, et les vrais chiffres",
 "t": [
  ...
  "Une correction s'impose, et elle vient du quotidien local au lendemain du match. Le Sport alsacien du 14 novembre donne « plus de 6 000 » spectateurs et 40 000 francs, avec un ancien record de 5 023 et 28 595 francs. Ce sont les chiffres du Sport alsacien qui sont faux.",
  "La même page garde un détail que personne d'autre n'a retenu : « Une élégante Alsacienne, Mlle Gspann, remit avant le match au capitaine colmarien, Oscar Tellechea, un beau bouquet, parce que ce derby tombait le jour de l'Armistice. »",
 ],
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "Lens, le Red Star, et la faute d'un jour",
 "t": [
  ...
  "Un jour de retard sur un papier, et la victoire ne compte plus.",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "Mai 1939, on se l'arrache",
 "t": [
  "Le 12 mars 1939, L'Echo de Sélestat le décrit comme « Halbinvalide », à demi invalide. Il marque deux fois quand même. Le lendemain, le journal de Guebwiller parle de « seiner alten Verletzung », son ancienne blessure. Le 26 mars, Le Sport alsacien : « Boudjemaa ist immer noch zu sehr durch seine Verletzung gehandicapt ».",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "« Le Tunisien »",
 "t": [
  ...
  "« Den Tunesier ». C'est la première fois, dans tout le dépouillement, qu'un journal le désigne par son pays et sans se tromper.",
  "Le Mémorial de Saint-Étienne l'avait appelé « l'Algérien » le jour même où son club le signait, en juillet 1936. Paris-soir écrivait « encore des Nord-Africains ». Le Sport alsacien écrivait « l'Arabe ».",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "Son portrait de fin de saison",
 "t": [
  ...
  "Le même jour, le même journal écrit que le club ne le vendra pas : « Les professionnels de la première équipe du S. R. C. ne seront pas cédés par la direction du club, à ce qu'on dit. Il s'agit en premier lieu de Wozniok, Demuth, Delacourt, Gabrillargues, Othman, Zopp, Tellechea, Boudjemaa, Emonoz. » Il reste à Colmar.",
  "Le 19 août 1939, les Colmarer neueste Nachrichten publient la composition du premier match de la saison : il en fait partie.",
  "C'est la dernière fois que le quotidien de Colmar imprime son nom. Deux semaines plus tard, la guerre.",
 ],
...
{"ch": "6. LA GUERRE", "titre": "La captivité",
 "t": [
  ...
  "C'est aussi le seul passage, dans toute la documentation rassemblée, qui touche à sa vie en dehors du football entre 1941 et 1945. Quatre années de sa vie tiennent dans quatre mots : « rentré de captivité ».",
 ],
 "fac": None,
...
{"ch": "7. SAINT-ÉTIENNE, DIVISION 1", "titre": "Ses débuts sous le maillot vert",
 "t": [
  ...
  "Puis vient le 19 septembre contre Bordeaux. La furonculose, la clinique, sept mois d'absence. Il ne reviendra que le 8 mai 1938, et toute la saison tiendra dans ces trois dernières semaines.",
 ],
 "fac": None,
...
{"ch": "7. SAINT-ÉTIENNE, DIVISION 1", "titre": "« L'homme qui donna le moral à l'équipe »",
 "t": [
  ...
  "C'est le plus beau titre qu'un journal lui ait donné.",
  "Il faut ajouter ceci : la fiche officielle du club ne lui attribue pas ce but du 22 mai contre Toulouse. Le journal de la ville, lui, le lui attribue et le décrit. La fiche est à corriger.",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "Colmar, 1946 : les seules images hors du terrain",
 "t": [
  "Il revient au S.R. Colmar le 20 septembre 1945. C'est Lehmann, le président du club, qui vient le chercher en personne.",
  "En janvier 1946, il reçoit un avis défavorable à sa demande de licence amateur. C'est l'année où la Fédération interdit pendant deux ans tout nouveau transfert de joueurs venus d'Afrique du Nord.",
...
{"ch": "5. LES SAISONS EN FRANCE", "titre": "« Boudjema bourreau ! »",
 "t": [
  ...
  "Le 16 février 1947, Colmar 1 Angers 0 : aucune trace de lui. C'est le dernier match connu de sa carrière.",
 ],
...
{"ch": "8. LA MORT", "titre": "L'acte",
 "t": [
  ...
  "Il est mort à trente-deux ans, célibataire, loin des siens. Personne à Colmar ne savait le nom de ses parents.",
 ],
...
{"ch": "8. LA MORT", "titre": "Le seul qui le nomme par son pays",
 "t": [
  ...
  "L'Écho d'Alger écrit « l'excellent footballer tunisien », et il est le seul à rappeler ses trois clubs, Saint-Etienne, Nice et Colmar. Le journal le plus proche de chez lui est aussi celui qui le reconnaît le mieux. Il le place ce jour-là entre un résultat de boxe et la mort de deux dirigeants algérois.",
...
{"ch": "8. LA MORT", "titre": "Le silence des journaux de sa ville",
 "t": [
  ...
  "L'annonce de sa mort est venue de Paris, de L'Équipe et de France-Soir, puis d'Alger et de Rabat. Dans la ville où il mourait, les journaux n'en ont rien dit.",
