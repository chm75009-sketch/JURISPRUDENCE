...
__def("./textes-bdese.json", function(module){ module.exports = {
 ...
 "L2316-22": {
  ...
  global.MoteurBDESE = {
    ...
    champs: [["Identité",[["entreprise","Dénomination sociale","texte"],["dateAudit","Date à laquelle la situation est décrite","AAAA-MM-JJ"],["effectif","Effectif de l'entreprise au sens de l'article L. 1111-2","nombre"],["etablissementsDistincts","L'entreprise comporte-t-elle plusieurs établissements distincts ?","oui / non"]]],["Le régime applicable",[["accordRecherche","La recherche d'un accord définissant la base a-t-elle été conduite ?","oui / non"],["accordEntreprise","Un accord d'entreprise définit-il la base ?","oui / non"],["accordEntrepriseVerse","Cet accord est-il joint au dossier ?","oui / non"],["accordBranche","À défaut, un accord de branche la définit-il ?","oui / non"],["accordBrancheVerse","Cet accord de branche est-il joint au dossier ?","oui / non"],["pieces","Pièces versées au dossier","liste d'objets"]]],["Les dates",[["dateSeuil50Atteint","Date à laquelle l'effectif a atteint cinquante salariés pendant douze mois consécutifs","AAAA-MM-JJ"],["dateFinMandat","Date de fin des mandats en cours","AAAA-MM-JJ"],["dateRenouvellementCSE","Date de renouvellement du comité, si elle est arrêtée","AAAA-MM-JJ"],["dateSeuil300Franchi","Date à laquelle le seuil de trois cents salariés est réputé franchi, après douze mois consécutifs de dépassement","AAAA-MM-JJ"]]],["Le contenu",[["base.themes","Les thèmes et rubriques que la base comporte, un par ligne","liste d'objets"],["base.anneesPassees","Nombre d'années passées couvertes","nombre"],["base.anneesSuivantes","Nombre d'années à venir couvertes","nombre"],["base.formePerspectives","Forme sous laquelle les années à venir sont renseignées : chiffrée, grandes tendances, ou mixte","texte"],["base.informationsNonRenseignables","Informations qui ne peuvent recevoir ni chiffres ni tendances, avec les raisons données","liste"]]],["La mise à disposition",[["base.support","Support de la base : informatique, papier, ou autre","texte"],["base.beneficiaires","Personnes ayant accès à la base","liste"],["base.niveau","Niveau auquel la base est mise en place : entreprise, établissement, ou les deux","texte"],["base.dateDerniereMiseAJour","Date de la dernière mise à jour","AAAA-MM-JJ"],["base.informationMiseAJour","Les bénéficiaires sont-ils informés de chaque actualisation ?","oui / non"],["base.preuveAcces","Trace des accès ou de la remise : journal, accusés, émargements","texte"]]],["Les consultations",[["accordPeriodiciteConsultations","Un accord fixe-t-il le contenu, la périodicité et les modalités des consultations récurrentes ?","oui / non"],["periodiciteConsultations","Périodicité que cet accord fixe, en années","nombre"],["reunionsAnnuellesAccord","Nombre de réunions annuelles que cet accord prévoit","nombre"],["accordDelaisConsultation","Un accord fixe-t-il les délais dans lesquels les avis sont rendus ?","oui / non"],["consultation.dateMiseADisposition","Date de mise à disposition des informations dans la base, ou de leur communication","AAAA-MM-JJ"],["consultation.nbExpertises","Nombre d'expertises en cours sur cette consultation","nombre"],["consultation.centralEtEtablissements","La consultation se déroule-t-elle à la fois au niveau central et d'établissement ?","oui / non"],["consultation.dateAvis","Date à laquelle l'avis a été rendu","AAAA-MM-JJ"]]]],
    propositions: {"accordRecherche":{"valeurs":["oui","non"],"libre":false,"aide":"Le régime supplétif ne s'applique pas faute d'avoir cherché : il s'applique en l'absence d'accord, ce qui est un fait à établir. Tant que la recherche n'est pas déclarée faite, le module répond « régime indéterminé » et n'audite aucun contenu."},"accordEntreprise":{"valeurs":["oui","non"],"libre":false,"aide":"Accord d'entreprise, ou, en l'absence de délégué syndical, accord entre l'employeur et le comité adopté à la majorité des titulaires (L. 2312-21, al. 1er)."},"accordEntrepriseVerse":{"valeurs":["oui","non"],"libre":false,"aide":"Un accord déclaré et non versé laisse le régime indéterminé : le contenu exigible est celui qu'il définit, et il ne se devine pas."},"accordBranche":{"valeurs":["oui","non"],"libre":false,"aide":"L'accord de branche ne peut définir la base que dans les entreprises de moins de trois cents salariés, et seulement à défaut d'accord d'entreprise."},"accordBrancheVerse":{"valeurs":["oui","non"],"libre":false,"aide":"Même règle que pour l'accord d'entreprise : déclaré et non versé, il laisse le régime indéterminé."},"etablissementsDistincts":{"valeurs":["oui","non"],"libre":false,"aide":"Le niveau auquel la base est mise en place se fixe par l'accord de l'article L. 2312-21, 2°."},"accordPeriodiciteConsultations":{"valeurs":["oui","non"],"libre":false,"aide":"Attention : ce n'est PAS l'accord qui définit la base. Celui-ci relève de l'article L. 2312-19 et porte sur le contenu, la périodicité et les modalités des consultations récurrentes. Un accord sur la base ne déplace pas la périodicité des consultations."},"accordDelaisConsultation":{"valeurs":["oui","non"],"libre":false,"aide":"L'accord de l'article L. 2312-19, 4°, fixe les délais dans lesquels les avis sont rendus. À défaut, le délai supplétif de l'article R. 2312-6 s'applique : un mois, deux avec expert, trois lorsque des expertises interviennent au niveau central et d'établissement."},"base.informationMiseAJour":{"valeurs":["oui","non"],"libre":false,"aide":"C'est cette information — ou la communication des informations — qui fait courir le délai de consultation (R. 2312-5). Sans elle, le délai ne court pas."},"base.formePerspectives":{"valeurs":["chiffrée","grandes tendances","mixte"],"libre":true,"indicatif":true,"aide":"Les trois années à venir se présentent sous forme de données chiffrées ou, à défaut, sous forme de GRANDES TENDANCES (R. 2312-10). Les tendances suffisent : exiger des chiffres produirait des non-conformités fausses. L'employeur doit en revanche indiquer, en les motivant, les informations qui ne peuvent recevoir ni chiffres ni tendances."},"base.niveau":{"valeurs":["entreprise","établissement","les deux"],"libre":true,"indicatif":true,"aide":"En l'absence d'accord, la base est constituée au niveau de l'entreprise (R. 2312-11) ; l'accord peut fixer un autre niveau dans les entreprises à établissements distincts."},"base.themes.theme":{"valeurs":["Investissements","Egalité professionnelle entre les femmes et les hommes au sein de l'entreprise","Fonds propres, endettement et impôts","Rémunération des salariés et dirigeants, dans l'ensemble de leurs éléments","Activités sociales et culturelles","Rémunération des financeurs, en dehors des éléments mentionnés au 4°","Flux financiers à destination de l'entreprise","Partenariats","Pour les entreprises appartenant à un groupe, transferts commerciaux et financiers entre les entités du groupe","Environnement (1) A-Politique générale en matière environnementale","Représentation du personnel et Activités sociales et culturelles","Environnement (52)"],"libre":true,"indicatif":true,"aide":"Les rubriques que le décret nomme, découpées depuis son texte. Un accord peut en retenir d'autres — mais aucun ne peut descendre sous le plancher des dix thèmes de l'article L. 2312-21, alinéa 3."},"pieces":{"valeurs":["accord-bdese"],"autres":["accord-branche"],"libre":true,"multiple":true,"indicatif":true,"aide":"Les pièces versées. Un régime conventionnel se prouve par le texte de son accord."}},
    listes: [],
    colonnes: {},
    piecesAppelees: {},
  };
